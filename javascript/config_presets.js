...
onUiUpdate(function() {
	...
	gradioApp().querySelectorAll("#script_config_preset_save_button").forEach(el => el.setAttribute("title", "Save selected fields with the new preset name. Will overwrites an existing preset with the same name."))
